...
package com.hl_zhaoq.digou.utils.kankan.wheel.widget;

import java.util.LinkedList;
import java.util.List;

import com.hl_zhaoq.digou.utils.kankan.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		 ...
		 * 婵炶揪缍�濞夋洟寮妶澶嬪殜妞ゅ繐瀚粻鎺楁煟閵娿儱顏柡浣稿⒔閻ヮ亪宕犻敍鍕槷闂佸吋婢樻總鏃傜箔婢舵劕鍙婃い鏍ㄧ☉娴煎酣寮堕崼顒佸
		...
		// 闁荤姳绀佹晶浠嬫偪閸℃瑧妫柛顭戝櫘閸燂拷
		paint.setStrokeWidth((float) 3);
		// 缂傚倷鐒﹂敋闁糕晜顨嗙粙澶嬬節閸涱垳褰鹃梺鐑╂櫅椤曨參宕甸敓锟�
		canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);
		// 缂傚倷鐒﹂敋闁糕晜顨嗙粙澶岋拷锝庡幘閻濆爼鏌ｉ埡渚囧殶闁搞倧鎷�
		canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
		// */
	}
