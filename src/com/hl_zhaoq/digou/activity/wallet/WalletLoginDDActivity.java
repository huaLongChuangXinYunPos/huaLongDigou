...
public class WalletLoginDDActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = WalletLoginDDActivity.this;
		init();
	...
	private void toLoginBuyer() {
		if (TextUtils.isEmpty(w_log_BuyerName.getText().toString())) {
			PromptManager.showMyToast(WalletLoginDDActivity.this, "用户名不能为空");
			return;
		}
		if (TextUtils.isEmpty(w_log_BuyerPwd.getText().toString())) {
			PromptManager.showMyToast(WalletLoginDDActivity.this, "用户密码不能为空");
			return;
		}
