...
public class PayStyleBean {
	...
	public String getcPayStylePic() {
		return cPayStylePic.trim();
	}

	public void setcPayStylePic(String cPayStylePic) {
		this.cPayStylePic = cPayStylePic;
	}

	public String getcPayStyleName() {
		return cPayStyleName.trim();
	}
