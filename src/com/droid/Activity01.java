...
public class Activity01 extends Activity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_relocation_main);
	...
	private class ResultListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.my_relocation_list_item, null);
	...
	public class ListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // 定位
				convertView = inflater.inflate(R.layout.my_relocation_frist_list_item, null);
				...
				convertView = inflater.inflate(R.layout.my_relocation_recent_city, null);
				...
				convertView = inflater.inflate(R.layout.my_relocation_total_item, null);
			} else {
				if (convertView == null) {
					convertView = inflater.inflate(R.layout.my_relocation_list_item, null);
	...
	class HotCityAdapter extends BaseAdapter {
		...
		@Override
		public View getView(int position, View convertView, ViewGroup parent) {
			convertView = inflater.inflate(R.layout.my_relocation_item_city, null);
	...
	private void initOverlay() {
		...
		overlay = (TextView) inflater.inflate(R.layout.my_relocation_overlay, null);
