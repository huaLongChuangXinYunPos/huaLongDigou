...
public class PayZhiActivityTest extends FragmentActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.paybyzhifubao_main2);
		init();
	}
		...
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					Toast.makeText(PayZhiActivityTest.this, "支付成功",
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						Toast.makeText(PayZhiActivityTest.this, "支付结果确认中",
								Toast.LENGTH_SHORT).show();
					} else {
						// 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
						Toast.makeText(PayZhiActivityTest.this, "支付失败",
								Toast.LENGTH_SHORT).show();
					}
				}
				break;
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(PayZhiActivityTest.this, "检查结果为：" + msg.obj,
						Toast.LENGTH_SHORT).show();
				break;
			}
			case 999: {
				PromptManager.closeMyProgressDialog();
				PromptManager.showMyToast(PayZhiActivityTest.this, "支付宝支付成功");
				break;
			}
			default:
				break;
...
//		PromptManager.showMyToast(getApplicationContext(), "支付宝支付成功");
		PromptManager.showMyProgressDialog(PayZhiActivityTest.this);
	...
	public void payon() {
		 ...
		 */
		// 订单
		String orderInfo = getOrderInfo(getOutTradeNo(), "商品订单", "0.02");
		...
		try {
			...
			Runnable payRunnable = new Runnable() {
				...
				public void run() {
					// 构造PayTask 对象
					PayTask alipay = new PayTask(PayZhiActivityTest.this);
					// 调用支付接口，获取支付结果
	...
	public void check(View v) {
		Runnable checkRunnable = new Runnable() {
			...
			public void run() {
				// 构造PayTask 对象
				PayTask payTask = new PayTask(PayZhiActivityTest.this);
				// 调用查询接口，获取查询结果
